...
Camera-sensor data is used to estimate and approximate naturalistic virtually lighting that is dynamically added to the objects in a scene.
Depending on the scene and lighting conditions, this can be a computationally intensive process and -- depending on the resulting virtual lighting -- lead to improved or worsened object legibility.
