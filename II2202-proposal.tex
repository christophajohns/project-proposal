...
A similar impression emerges when examining \gls{CPU} usage: taking only the overall mean utilization into consideration, we would have to reject our hypothesis \textbf{H2}.
