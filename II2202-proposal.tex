...
While there has been extensive research on the effect of design decisions on immersion in digital games -- even in \gls{AR} games in a few cases (e.g. \cite{}) -- the effect of lighting and more specifically automatic naturalistic lighting in \gls{AR} games seems not to have been examined yet.
...
Depending on the scene and lighting conditions, this can be a computationally intensive process \cite{steed_constructing_2016} and -- depending on the resulting contrast -- lead to improved or worsened usability \cite{gabbard_effects_2006}.
